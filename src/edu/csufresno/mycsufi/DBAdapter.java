...
public void insert_ToDatabase(DBAdapter _db, ArrayList<StudentClass> _classes){
  ...
  public Cursor getAllCursor() {
    return db.query(DATABASE_TABLE, 
                    new String[] { KEY_ID, KEY_CLASSNAME, KEY_INSTRUCTOR, KEY_ROOM, KEY_BUILDING, KEY_STARTTIME, KEY_ENDTIME, KEY_DAYS}, 
  ...
  private static class toDoDBOpenHelper extends SQLiteOpenHelper {
	  ...
	  private static final String DATABASE_CREATE = "create table " + 
	    ...
	    KEY_CLASSNAME + " text not null, " + KEY_INSTRUCTOR + " text not null, " + KEY_ROOM + " text not null, " + KEY_BUILDING + " text not null, " + 
	    KEY_STARTTIME + " text not null, " + KEY_ENDTIME + " text not null, " + KEY_DAYS + " text not null);";
